// https://www.shadertoy.com/view/4sdyRH
...
void mainImage( out vec4 fragColor, in vec2 U ) {
    ...
    float amp = .0;  
    amp -= texture2D(iChannel0,vec2(400.,0.),0.).x;      // store global sound amplitude
    ...
    vec3 pat  = texture2D(iChannel1, U / R).xyz;                  // get image texture from buffer A
